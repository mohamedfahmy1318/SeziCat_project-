...
class BatteryRateScreen extends StatelessWidget {
  const BatteryRateScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: ColorUtil.batteryColor,
        leading: IconButton(
          onPressed: () {
        ...
        title: Text('Battery Rate'),
        actions: [
          Padding(
            padding: const EdgeInsets.all(8.0),
            child: SvgPicture.asset(
              PathUtil.batteryLine,color: Colors.white24,
            ),
          ),
        ],
        centerTitle: true,
        ...
        systemOverlayStyle: SystemUiOverlayStyle(
            ...
            statusBarColor: ColorUtil.batteryColor,
            ...
            child: Column(
              ...
              children: [
                ...
                healthScoreItem(
                    width: 355.w,
                    height: 170.h,
                    polygonIconColor: ColorUtil.batteryColor,
                  readMoreColor:ColorUtil.batteryColor,
                ),
                SizedBox(
                  height: 30.h,
                ),
